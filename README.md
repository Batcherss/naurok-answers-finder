...
* **Price:** $20.00 USD (Litecoin) (One-time payment).
...
* **Вартість:** 20$ USD (Litecoin) (Одноразовий платіж).
...
* **Показники точності:**
    * **Текст та математика:** До 90% точності.
...
### Media
* [Переглянути знімки екрана та анімовані демонстрації (GALLERY.md)](./GALLERY.md)
---
...
* **Цена:** 20$ USD (Litecoin) (Единоразово).
...
Litecoin adress: LPtHYyDmJUe9inA5uqGRrDysJ9G4dvdp1k
